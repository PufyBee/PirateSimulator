...
public class RouteWeightPanel : MonoBehaviour
{
    ...
    private void CreateRow(TradeRouteData route, int index, Color routeColor)
    {
        ...
        valRect.anchorMax = new Vector2(0, 1f);
        valRect.pivot = new Vector2(0, 1);
        valRect.anchoredPosition = new Vector2(22, 0);
        valRect.sizeDelta = new Vector2(35, 18);
        ...
        sliderBgRect.anchoredPosition = new Vector2(60, 4);
        sliderBgRect.sizeDelta = new Vector2(rowWidth - 76f, SLIDER_H);
